...
<body>
	...
	<a href="search_brick.php"><input class="login-btn color-1" type="submit" name="" value="Search"> 
	</a>

	<a href="view_brick.php"><input class="login-btn color-2" type="submit" name="" value="View"> 
	</a>


	<a href="logout.php"><input class="login-btn color-3" type="submit" name="" value="LogOut" style="background"> 
	</a>
...
<?php 
	if($_POST['submit'])
	{
		...
		if($name != "" && $phone != "" && $no != "" && $load != ""  &&  $type !=  ""  && $fuel !=  "" &&  $fuelT != ""  && $tyre != "" && $dest != "" && $date != "" && $time != "")
		{

	$query 	=	"INSERT INTO brick_data(driver_name, phone, vehicle_no, max_load, type, fuel, fuel_type, tyre_pressure, destination, date, time) values('$name','$phone','$no','$load','$type', '$fuel', '$fuelT', '$tyre','$dest','$date','$time')";
