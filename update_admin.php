	...
	<div class="container">
		...
		<div class="form">
			...
			<div class="input_field terms">
				...
				<p>I want to change the details.</p>
			</div>
...
<?php 
	...
	$query = "UPDATE admin set fname='$fname',lname='$lname', password='$pwd', gender='$gender', email='$email', phone='$phone', address='$address' WHERE id='$id'";
	...
	if($data){
		...
		<meta http-equiv = "refresh" content = "0; url = http://localhost/website/displayadmin.php" />
