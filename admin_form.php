	...
	<div class="container">
		...
		<div class="form">
			...
			<div class="input_field terms">
				...
				<p>All above details are correct.</p>
			</div>
...
<?php 
	...
	$query 	=	"INSERT INTO admin(fname, lname, password, gender, email, phone, address) values('$fname','$lname','$pwd','$gender','$email','$phone','$address')";
