...
<?php 
	...
	$query = "UPDATE user set fname='$fname',lname='$lname', password='$pwd', gender='$gender', email='$email', phone='$phone', address='$address' WHERE id='$id'";
	...
	if($data){
		...
		<meta http-equiv = "refresh" content = "0; url = http://localhost/website/displayuser.php" />
